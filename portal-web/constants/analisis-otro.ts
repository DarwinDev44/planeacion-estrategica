...
export const CONCLUSION_OTRO =
  "Las tres peticiones con mayor peso, prácticamente empatadas entre sí, son: una universidad más conectada con la vida real (prácticas y pasantías tempranas, salidas de campo, vínculo efectivo con las empresas y una oferta académica más amplia); una institución de excelencia (acreditada, reconocida entre las mejores del país y fortalecida en investigación y laboratorios); y un cuerpo docente de mayor calidad, con mejor enseñanza y, a la vez, mejores condiciones de contratación, formalización y remuneración, junto con atención al bienestar y la salud mental de la comunidad. El modelo educativo divide opiniones: unos piden consolidar el MEDIT y otros ajustarlo o replantearlo, lo que sugiere un reto de apropiación que el plan debe atender con participación de la comunidad. Persisten además necesidades concretas de infraestructura (internet, aulas, escenarios deportivos) y de gestión (burocracia, comunicación, manejo de recursos). La expectativa de futuro que predomina es ambiciosa y positiva; sin embargo, entre quienes imaginaron la universidad a 10 años, cerca de una de cada cinco respuestas anticipa una institución igual o en declive, en algunos casos por decisiones percibidas como improvisadas. Para el Plan Estratégico 2027–2037 esto implica priorizar la conexión con el entorno laboral, elevar la calidad de la enseñanza y las condiciones docentes, resolver el debate sobre el modelo educativo y responder a las demandas cotidianas que sostienen la confianza institucional.";
